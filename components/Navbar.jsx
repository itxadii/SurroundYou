...
const Navbar = () => {
    return (
        ...
        <div className='h-30 w-full font-bold flex justify-between items-center p-4' style={{ backgroundImage: `url(${backgroundImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            className="inline-flex items-center gap-2 bg-[#FFDD00] text-black font-bold border-3 border-black rounded-md px-4 py-3 m-10 hover:bg-[#f9d300] transition-all duration-100 shadow-[0_2px_4px_rgba(0,0,0,0.2)] transform hover:scale-101 hover:shadow-2xl ease-in-out"
            >
            <img
